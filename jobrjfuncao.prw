...
"NT9_CFUNDP", "RAL_FUNCAO", "RB2_FUNCAO", "RB4_FUNCAO", "RB5_FUNCAO", "RB7_FUNCAO", "RBD_FUNCAO", "RBT_FUNCAO", "RED_CODFUN", "REL_CODFUN",;
"DB_RHFUNC", "R7_FUNCAO", "TFF_FUNCAO", "TIO_FUNCAO", "TJ1_FUNC", "TJ2_FUNC", "TJ5_FUNC", "TMO_CODFUN", "RCL_FUNCAO", "REY_CODFUN", "QS_FUNCAO",;
"TMY_NOVFUN", "TWN_FUNCAO", "V7_FUNC", "TXB_FUNCAO", "TYA_CODFUN", "VAI_FUNCAO", "TXI_FUNCAO", "TX8_FUNCAO", "TOA_CODIGO", "TJ7_CODIGO",;
"TI0_FUNCAO", "TGC_CODFUN", "TAN_CODFUN", "TAK_CODFUN", "TAF_CODCON", "RE0_CODFUN"}
Local xN
Local aArqUpd := {}
